...
public class AddObserver extends AppCompatActivity {
        ...
        dbm = new DatabaseManager(this);
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(phoneNum) ||
                    ...
                    Toast.makeText(AddObserver.this, "لطفا اطلاعات را به طور کامل پر کنید!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Log.i("Zeinab", "zisa");
                    dbm.insertObserver(s);

                    Toast.makeText(AddObserver.this, "ساخت ناظر با موفقیت انجام شد!", Toast.LENGTH_SHORT).show();


                    startActivity(new Intent(AddObserver.this, CreateProject.class));
                    finish();
