        ...
        dbm = new DatabaseManager(this);
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(phoneNum) ||
                    ...
                    Toast.makeText(AddOwner.this, "لطفا اطلاعات را به طور کامل پر کنید!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Toast.makeText(AddOwner.this, "ساخت مالک با موفقیت انجام شد!", Toast.LENGTH_SHORT).show();


                    startActivity(new Intent(AddOwner.this, CreateProject.class));
                    finish();
